      ...
      <div className="custom-screen">
        <div className="max-w-3xl space-y-6 text-gray-600 dark:text-gray-300">
          <h2 className="text-gray-800 dark:text-gray-50 text-2xl font-semibold sm:text-3xl">
            This college-course-structured Career Path covers all the basics any
            CS professional needs to thrive in the tech world.
          </h2>
          <p>
            The IO Academy is a hands-on, immersive program in computer science
            that equips high school students with the skills necessary to change
            the world, so beginners, intermediates, and experts all welcome to
            this course.
          </p>
          <div>
                ...
                <li key={idx} className="flex gap-x-5">
                  <div className="flex-none">
                    <svg
                      ...
                      strokeWidth={1.5}
                      stroke="currentColor"
                      className="w-6 h-6 text-blue-600 dark:text-sky-500"
                    >
                      <path
                        strokeLinecap="round"
