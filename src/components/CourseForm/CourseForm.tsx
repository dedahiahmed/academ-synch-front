...
export default function CourseForm() {
  ...
  return (
    <div className="w-full px-[20rem] h-full bg-gray-100  ">
      <FormProvider {...form}>
        <form
          className=" mt-[1.25rem] lg:mt-[2.5rem] space-y-4 bg-white rounded shadow-lg p-4 px-4 h-[50%] "
          noValidate
        >
          {/*name*/}
        ...
        border-stone-900 py-[0.3125rem] pl-[0.625rem] pr-[1.5rem] font-text  csm:w-[20.625rem] lg:mb-[0.5rem]  lg:h-[11.5625rem]  lg:gap-[0.625rem] lg:py-[0.9375rem] lg:pl-[0.625rem] lg:pr-[2.5rem]"
          ...
          <button
            className="mb-[1.25rem] w-[100%] inline-flex items-center justify-center rounded-lgbg-cblue hover:bg-hblue px-[2.25rem] py-[0.9375rem]
"
          >
